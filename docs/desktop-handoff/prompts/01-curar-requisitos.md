...
Use `docs/project/legacy-import-manifest.md` para ler apenas as fontes funcionais permitidas no repositório WebFit Web original. O caminho da origem deve ser fornecido por mim ou descoberto no workspace; não copie a implementação técnica antiga.
