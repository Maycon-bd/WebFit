...
const MarketingPanel = () => {
  ...
  const [activeSubTab, setActiveSubTab] = useState('canvas'); // 'canvas', 'mensagens', 'modelos', 'beneficios', 'nutrilinks', 'site'

  // Modelos de Mensagens local editors
  const [isEditingModel, setIsEditingModel] = useState(null);
  ...
  const handleSaveTemplate = (e) => {
    ...
    alert('Modelo de mensagem atualizado!');
  };
